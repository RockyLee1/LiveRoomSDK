...
typedef enum {
    ...
    PLRTCStreamingErrorEngineUnInit = -3014,
} PLStreamError;
...
typedef NS_ENUM(NSUInteger, PLRTCVideoSizePreset) {
    PLRTCVideoSizePreset144x192 = 0,    //4:3
    PLRTCVideoSizePreset176x320,        //16:9
    PLRTCVideoSizePreset240x320,        //4:3
    PLRTCVideoSizePreset240x432,        //16:9
    PLRTCVideoSizePreset368x640,        //16:9
...
///音视频码率帧率类型
typedef NS_ENUM(NSUInteger, PLRTCAVStatisticType) {
    PLRTC_AVS_UNKNOWN = 0,    //未知类型
    PLRTC_AVS_AUDIO_BITRATE = 1,   //音频传输码率
    PLRTC_AVS_VIDEO_BITRATE = 2,   //视频传输码率
    PLRTC_AVS_VIDEO_FRAMERATE = 3,  //视频帧率
    PLRTC_AVS_AUDIO_PACKET_LOSS_RATE = 4, //音频丢包率,千分比
    PLRTC_AVS_VIDEO_PACKET_LOSS_RATE = 5, //视频丢包率,千分比
};
